...
2.  **(Highly Recommended) Rust Installation**: For an interactive experience, please arrive with Rust already installed on your computer.
    * **Installation Link**: Follow the official guide at [rust-lang.org/tools/install](https://www.rust-lang.org/tools/install).

---

## 🛠️ How to Verify Your Installation

Open your terminal (or Command Prompt on Windows) and try running `rustc --version` and `cargo --version`. If they output a version number without errors, you're all set!

---

## 🦀 What is the "Rust Crush Bootcamp"



## 💻 GitHub Repository

We will use this repository during the course to share code and examples. It's empty for now—we'll fill it up together:
[https://github.com/FrancescoXX/rust-crush-bootcamp](https://github.com/FrancescoXX/rust-crush-bootcamp)
